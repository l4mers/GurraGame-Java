...
//        int beneficialY = gamePanel.screenHeight / 2;
    ...
    public void drawInventory(){
        ...
        int frameWidth = gamePanel.screenWidth / 2 + gamePanel.tileSize + gamePanel.tileSize / 2;
        int frameHeight = gamePanel.screenHeight - gamePanel.tileSize * 2;
        drawSubWindow(frameX, frameY, frameWidth, frameHeight);

        int subFrameX = frameX + gamePanel.tileSize / 2;
        int subFrameY = frameY + gamePanel.tileSize / 2;
        ...
        while(col < 6 && row < 6){
            ...
            col++;
            subFrameX += gamePanel.tileSize + gamePanel.tileSize / 2;
            rec.x = subFrameX;
            if(col == 6){
                col = 0;
                row++;
                subFrameX = frameX + gamePanel.tileSize / 2;
                subFrameY += gamePanel.tileSize + gamePanel.tileSize / 2;
                rec.x = subFrameX;
                rec.y = subFrameY;
            }
        }
...
//        //CREATE EQUIPMENT BOXES
//        final int eqBoxX = gamePanel.tileSize;
//        final int eqBoxY = gamePanel.tileSize;
//        final int eqBoxWidth = gamePanel.tileSize *2;
//        final int eqBoxHeight = gamePanel.tileSize*2;
//        drawSubWindow(eqBoxX, eqBoxY, eqBoxWidth, eqBoxHeight);
    ...
    public void drawToolTip(float def){
        ...
        String test = gamePanel.player.currentWeapon.name;
        String[] test2 = gamePanel.player.currentWeapon.toolTip.split("\n");
        g2.setColor(Color.white);
        ...
        g2.setFont(g2.getFont().deriveFont(def));
    }
